...
sap.ui.define(['sap/ui/thirdparty/jquery'], function(jQuery) {
	 ...
	 *
	 * @namespace
	 * @name module:com/ui5/dotproject/timecard/thirdparty/cursorPos
	 * @public
	 * @since 1.58
	 */
	 ...
	 * @since 0.9.0
	 * @function
	 * @requires module:com/ui5/dotproject/timecard/thirdparty/cursorPos
	 */
	var fnCursorPos = function cursorPos(iPos) {
		...
		if ( this.length === 1 && ((sTagName == "INPUT" && (sType == "text" || sType == "password" || sType == "search" || sType == "tel")) // stupid fix for tel types (typical SAP)
				|| sTagName == "TEXTAREA" )) {
